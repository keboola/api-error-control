...
{
    public function testNewAppErrorResponse(): void
    {
    ...
    public function testUserErrorResponse(): void
    {
        $exception = new class() extends Exception implements UserExceptionInterface {
        };
        $exceptionMessage = new ExceptionMessage(
            'error message',
            123,
